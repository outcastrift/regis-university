 ...
 * Created by Samuel Davis on 29-May-16.
 * Class Description
 */
public class mt310 {
    /**
     ...
     **/
    private static boolean[] isFunction_OrOnto_OrOneToOne(ArrayList<Integer> domain, ArrayList<Integer> coDomain, Expression function) {
        //create result array
