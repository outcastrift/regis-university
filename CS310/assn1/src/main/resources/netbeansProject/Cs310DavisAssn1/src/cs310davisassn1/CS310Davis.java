...
public class CS310Davis {
    ...
    private static void performTestSet2(String fileName) {
       ...
       //This is the right way to do things, specifying a path directly to a file is not maintable code. 
       ...
       // file = new File(classLoader.getResource(fileName).getFile());
        ...
        File file = null;
        try {
             //Have to use this method though because we are providing a project as a deliverable. Not compiled code.  
    ...
    private static void performTestSet3() {
        ...
        if (donor1ForTestSet3.equals(donor1ForTestSet3)) {
            System.out.println("Donor objects are equal.");
        } else {
            System.out.println("Donor objects are not equal.");
        }
